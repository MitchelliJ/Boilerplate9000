...
8. **Test Requirements** — For each functional requirement, describe what a passing unit test would verify. Use the format: "Given [state], when [action], then [assertion]." These are mandatory, not optional.
