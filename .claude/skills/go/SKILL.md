...
- **CONFIRM GREEN tasks:** **You** run the test suite with the bash tool. Paste the pass output. If anything fails, re-spawn `write-code` with the failure output and repeat. Do not advance on a red suite.
